...
# Indexes
#
#  index_b_twelves_on_action_plan_id  (action_plan_id)
#  index_b_twelves_on_deleted_at      (deleted_at)
#  index_b_twelves_on_slug            (slug) UNIQUE
#
# Foreign Keys
#
...
class BTwelfTest < ActiveSupport::TestCase
  # test "the truth" do
  #   assert true
  # end
end
