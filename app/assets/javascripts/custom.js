...
if (location.pathname.split("/")[1]== ''){
  ...
  $('a[href^="/' + location.pathname.split("/")[1] + '"]').parents('li.nav-item').children('a.nav-link').addClass('active');
  $('a[href^="/' + location.pathname.split("/")[1] + '"]').parents('div.sidebar-collapse').addClass('show');
